...
import { BscScanIcon, Flex, IconButton, Link, Button, useModal } from '@vknighthub/uikit'
      ...
      if (!profile) {
        return (
          <ReactRouterLink to="/create-profile">
            <Button mt="16px" variant="vknight">{t('Activate Profile')}</Button>
          </ReactRouterLink>
        )
      }
      return (
        <Button width="fit-content" mt="16px" onClick={onEditProfileModal} variant="vknight">
