...
import { Flex, Box, Text, Heading, Card, Skeleton } from '@vknighthub/uikit'
...
const Overview: React.FC = () => {
  ...
  return (
    <Page>
      <Heading scale="lg" mb="16px" id="info-overview-title" color="primaryDark">
        {t('vKnightHub Info & Analytics')}
      </Heading>
      <ChartCardsContainer>
        <Card>
      ...
      <Heading scale="lg" mt="40px" mb="16px" color="primaryDark"> 
        {t('Top Tokens')}
      </Heading>
