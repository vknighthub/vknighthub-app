...
import { Box, Button, Flex, Heading, LinkExternal } from '@vknighthub/uikit'
  ...
  return (
    <>
      ...
      <StyledPageHeader>
        <StyledHeaderInner>
          <div>
            <Heading as="h1" scale="xxl" color="primaryDark" mb="24px">
              {t('NFT Market')}
            </Heading>
            ...
            {account && (
              <Button as={NextLinkFromReactRouter} to={`${nftsBaseUrl}/profile/${account.toLowerCase()}`} mt="32px" variant="vknight">
                {t('Manage/Sell')}
              </Button>
            )}
          </div>
