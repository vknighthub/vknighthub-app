import { Box, Button, Flex, InjectedModalProps, LinkExternal, Message, Skeleton, Text } from '@vknighthub/uikit'
...
const WalletInfo: React.FC<WalletInfoProps> = ({ hasLowBnbBalance, onDismiss }) => {
  ...
  return (
    <>
      <Text color="primaryDark" fontSize="16px" textTransform="uppercase" fontWeight="bold" mb="8px">
        {t('Your Address')}
      </Text>
