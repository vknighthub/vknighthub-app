...
import { Text, PancakeToggle, Toggle, Flex, Modal, InjectedModalProps, ThemeSwitcher } from '@vknighthub/uikit'
import {
  useAudioModeManager,
    ...
    >
      <ScrollableContainer>
        <Flex pb="24px" flexDirection="column">
          <Text bold textTransform="uppercase" fontSize="18px" color="primaryDark" mb="24px">
            {t('Global')}
          </Text>
