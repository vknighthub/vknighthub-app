...
import { Text, Flex, Box, Skeleton, ArrowBackIcon, ArrowForwardIcon } from '@vknighthub/uikit'
...
const PoolTable: React.FC<PoolTableProps> = ({ poolDatas, loading }) => {
  ...
  return (
    <TableWrapper>
      <ResponsiveGrid>
        <Text color="primaryDark" fontSize="14px" bold>
          #
        </Text>
        <Text color="primaryDark" fontSize="14px" bold textTransform="uppercase">
          {t('Pool')}
        </Text>
      ...
      {sortedPools.length > 0 ? (
        <>
          ...
          <PageButtons>
            ...
            >
              <ArrowBackIcon color={page === 1 ? 'textDisabled' : 'primaryDark'} />
            </Arrow>
            ...
            >
              <ArrowForwardIcon color={page === maxPage ? 'textDisabled' : 'primaryDark'} />
            </Arrow>
          </PageButtons>
        </>
      ) : (
