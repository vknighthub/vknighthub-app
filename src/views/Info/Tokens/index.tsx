import { Card, Heading, Text } from '@vknighthub/uikit'
...
const TokensOverview: React.FC = () => {
  ...
  return (
    <Page>
      <Heading scale="lg" mb="16px" color="primaryDark">
        {t('Your Watchlist')}
      </Heading>
      ...
      <TopTokenMovers />
      <Heading scale="lg" mt="40px" mb="16px" id="info-tokens-title" color="primaryDark">
        {t('All Tokens')}
      </Heading>
